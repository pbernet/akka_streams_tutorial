...
| Class               | Description                                                                                                                                                                                                                                                                                    |
| ------------------- |------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [KafkaServerEmbedded.scala](src/main/scala/alpakka/env/KafkaServerEmbedded.scala)| [Embedded Kafka](https://github.com/embeddedkafka/embedded-kafka) is an in-memory Kafka instance                                                                                                                                                                                               | 
