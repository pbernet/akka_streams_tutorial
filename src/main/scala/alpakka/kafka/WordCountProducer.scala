...
object WordCountProducer {
  ...
  private class Application {
    ...
    val randomMap: Map[Int, String] = TextMessageGenerator.genRandTextWithKeyword(1000, 1000, 3, 5, 5, 10, fakeNewsKeyword).split("([!?.])").toList.zipWithIndex.toMap.map(_.swap)
